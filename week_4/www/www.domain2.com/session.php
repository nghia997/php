<?php
	...
	class Session
	{
		...
		/**
		* @param string $session_name to set name for this Session
		...
		*/
		...
		/**
		* function to close connected with database
		* @return boolean
		*/
		...
		/**
		* function to get data of id input session
		...
		*/
		...
		/**
		* function to insert a new session or update old session
		...
		*/
		...
		/**
		* function to remove a session with input id
		...
		*/
		...
		/**
		* function garbage collector to remove old sessions in database when the time exist are over
		...
		*/
		...
		/**
		* function to get sessionID or create a new random sessionID
		* @param string $id to get id of session in database
		...
		*/
		...
		/**
		* function to encrypt a data of session with sessionID
		...
		*/
		...
		/**
		* function to decrypt a data of session with sessionID
